package com.example.chatting.object;

import com.example.chatting.constant.Info;
import com.example.chatting.dto.InfoDTO;
...
public class ChatClientObject extends JFrame implements ActionListener, Runnable
{
    ...
    public void service(){
        ...
        if(serverIP==null || serverIP.length()==0){  //만약 값이 입력되지 않았을 때 창이 꺼짐
            System.out.println("Import Server Ip");
            System.exit(0);
        }
        //닉네임 받기
        nickName= JOptionPane.showInputDialog(this,"Insert Nickname","닉네임" ,JOptionPane.INFORMATION_MESSAGE);
        ...
        try{
            ...
            System.out.println("Don't find Server");
            e.printStackTrace();
            System.exit(0);
        } catch(IOException e){
            System.out.println("Don't connect Server");
            e.printStackTrace();
            System.exit(0);
        }
        try{
